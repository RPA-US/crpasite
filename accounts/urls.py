...
from .views import login_page, register_page, guest_register_view, register_page_reviewer, AccountDetailView, destroy
...
urlpatterns = [
    ...
    path("view/", AccountDetailView.as_view(), name="view"),
