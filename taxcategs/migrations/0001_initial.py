    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('decision', models.CharField(blank=True, choices=[('1', 'Accepted'), ('2', 'Refused'), ('3', 'Accepted with changes')], max_length=5)),
                ('image', models.ImageField(blank=True, upload_to=taxcategs.models.upload_image_path)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('result', models.CharField(blank=True, choices=[('1', 'New category term'), ('2', 'Taxonomic category proposal save as new category term'), ('3', 'New taxonomic category'), ('4', 'Taxonomic category replaced')], max_length=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(editable=False)),
                ('parent', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='taxcategs.OutputFormatSupported', verbose_name='parent')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_term', models.ForeignKey(limit_choices_to={'active': True}, on_delete=django.db.models.deletion.CASCADE, to='taxcategs.CategoryTerm')),
        ...
        migrations.AddField(
            model_name='categoryterm',
            name='output_formats_supported',
            field=models.ManyToManyField(blank=True, to='taxcategs.OutputFormatSupported'),
        ),
        migrations.AddField(
            model_name='categoryterm',
            name='tax_categ',
